...
import { getPipelines, listOpportunities } from "@/domain/opportunities/service"
...
export default async function PipelinePage({
  ...
  const pipeline = pipelines.find((p) => p.type === type && p.isDefault) ?? pipelines.find((p) => p.type === type)
  ...
  return (
    <div>
      <PageHeader
        title="Pipeline"
        description="Kanban view of opportunities — stage moves are audited"
        actions={
          <Link
            href="/app/leads/new"
      ...
      {!pipeline ? (
        <EmptyState title="No pipeline" description="Default pipelines are created with your organization." />
      ) : (
